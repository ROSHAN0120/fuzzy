...
#create_clock -name clk -period 60.000  [get_ports {clk}] 
# ----------------------------------------------------------------------------
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {risk[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {risk[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {risk[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {risk[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {risk[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {risk[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {risk[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {risk[7]}];  # "LD7"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {ss}];  # "BTNC"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {data_bus[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {data_bus[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {data_bus[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {data_bus[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {data_bus[4]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {data_bus[5]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {data_bus[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {data_bus[7]}];  # "SW7"
